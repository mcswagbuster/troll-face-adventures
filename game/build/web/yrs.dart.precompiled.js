...
["", "yrs.dart", , D, {
  ...
  main: [function() {
    var t1 = new D.SolarSystem(document.querySelector("#area"), null, null, null, null);
    P.scheduleMicrotask(t1.get$start(t1));
    D.addSound("bow.ogg", 65);
    D.addSound("pop1.ogg", 66);
  ...
  addSound: function(soundurl, index) {
    ...
    C.HttpRequest_methods.addEventListener$2(xhr, "load", new D.addSound_closure(index, audioContext, xhr));
    xhr.send();
  },
  keyboard: {
    "^": "Object;_yrs$_key",
    keyboard$0: function() {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new D.keyboard_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = H.setRuntimeTypeInfo(new W._EventStream(window, C.EventStreamProvider_keyup._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new D.keyboard_closure0(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    static: {keyboard$: function() {
        var t1 = new D.keyboard(P.HashMap_HashMap(null, null, null, P.$int, P.$int));
        t1.keyboard$0();
        return t1;
      }}
  },
  ...
  keyboard_closure0: {
    "^": "Closure:10;this_1",
    call$1: function(e) {
      this.this_1._yrs$_key.remove$1(0, J.get$keyCode$x(e));
    }
  },
  SolarSystem: {
    ...
    start$0: [function(_) {
      ...
      J.set$width$x(t1, t2);
      this.sun = D.PlanetaryBody$(this, "green", 0, 200, true, 4, true, 0, 0);
      $.enemy = D.PlanetaryBody$(this, "red 1", 500, 200, true, 4, true, 0, 0);
      P.Future_Future$delayed(C.Duration_1000000, new D.SolarSystem_start_closure(this), null);
      ...
      for (i = 0; i < 8; ++i) {
        z = platformscoord[i];
        $.get$platforms().push(D.PlanetaryBody$(this, "block 1", z[0], z[1], false, 0, false, 0, 0));
      }
      $.sun2 = this.sun;
      t1 = window;
      t2 = this.get$draw();
    ...
    AI$0: function() {
      ...
      if (t1.isvisable === 1) {
        t1.fire$1("blob");
        P.Future_Future$delayed(C.Duration_1000000, new D.SolarSystem_AI_closure(this), null);
    ...
    draw$1: [function(_) {
      ...
      this.renderTime = t1;
      if ($.get$k()._yrs$_key.containsKey$1(87))
        $.sun2.jump$0();
      $.sun2.moveleftright$1(0);
      if ($.get$k()._yrs$_key.containsKey$1(68))
        $.sun2.moveleftright$1(1);
      if ($.get$k()._yrs$_key.containsKey$1(65))
        $.sun2.moveleftright$1(-1);
      if ($.get$k()._yrs$_key.containsKey$1(190)) {
        if (!$.FIP) {
          $.sun2.fire$1("Arrow");
          $.FIP = true;
    ...
    drawPlanets$1: function(context) {
      ...
      $.enemy.draw$2(context, H.setRuntimeTypeInfo(new P.Point(0, 0), [null]));
      for (i = 0; t1 = $.get$arrowlist(), i < t1.length; ++i) {
        t1 = t1[i];
        t2 = new P.Point(0, 0);
        t2.$builtinTypeInfo = [null];
        t1.draw$2(context, t2);
      }
  ...
  PlanetaryBody: {
    ...
    fire$1: function(imgname) {
      ...
      arrow = D.PlanetaryBody$(this.solarSystem, imgname, this.x + xadjust, this.y, false, 8, true, 0, 0);
      t1 = this.image;
      t2 = this.imageright;
    ...
    static: {PlanetaryBody$: function(solarSystem, color, x, y, gravity, speed, candie, orbitRadius, orbitPeriod) {
        var t1 = new D.PlanetaryBody(color, orbitPeriod, solarSystem, null, orbitRadius, null, null, x, y, null, null, null, null, null, null, null, gravity, speed, candie, false, H.setRuntimeTypeInfo([], [D.PlanetaryBody]));
  ...
  addSound_closure: {
    ...
    call$1: function(e) {
      ...
      J.decodeAudioData$1$x(t1, W._convertNativeToDart_XHR_Response(this.xhr_2.response)).then$1(new D.addSound__closure(this.index_0, t1));
    }
  },
  addSound__closure: {
    ...
    call$1: function(buffer) {
      ...
      if (t2 >= 100)
        return H.ioore(t1, t2);
      t1[t2] = new D.addSound___doPlaySound(this.audioContext_4, buffer);
    }
  },
...
function dart_precompiled($collectedClasses) {
  ...
  function keyboard(_yrs$_key) {
    this._yrs$_key = _yrs$_key;
  }
