...
["", "audiotest.dart", , Y, {
  "^": "",
  main: [function() {
    Y.addSound("bow.ogg", 65);
    Y.addSound("pop1.ogg", 66);
    var t1 = H.setRuntimeTypeInfo(new W._EventStream(window, C.EventStreamProvider_keydown._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.main_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  ...
  addSound: function(soundurl, index) {
    ...
    C.HttpRequest_methods.addEventListener$2(xhr, "load", new Y.addSound_closure(index, audioContext, xhr));
    xhr.send();
  },
  main_closure: {
    "^": "Closure:10;",
    call$1: function(e) {
      if (J.get$keyCode$x(e) === 65)
        $.get$globalfunction()[65].call$0();
      if (e.keyCode === 66)
        $.get$globalfunction()[66].call$0();
    }
  },
  addSound_closure: {
    ...
    call$1: function(e) {
      ...
      J.decodeAudioData$1$x(t1, W._convertNativeToDart_XHR_Response(this.xhr_2.response)).then$1(new Y.addSound__closure(this.index_0, t1));
    }
  },
  addSound__closure: {
    ...
    call$1: function(buffer) {
      ...
      t1[t2] = new Y.addSound___doPlaySound(this.audioContext_4, buffer);
    }
  },
  addSound___doPlaySound: {
    "^": "Closure:0;audioContext_5,buffer_6",
    call$0: function() {
      var t1, source;
