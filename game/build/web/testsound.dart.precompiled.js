...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|Blob|DOMError|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["", "testsound.dart", , S, {
  ...
  main: [function() {
    var t1 = new S.SolarSystem(document.querySelector("#area"), null, null, null, null);
    P.scheduleMicrotask(t1.get$start(t1));
    S.addSound("bow.ogg", 65);
    S.addSound("pop1.ogg", 66);
  ...
  addSound: function(soundurl, index) {
    ...
    C.HttpRequest_methods.addEventListener$2(xhr, "load", new S.addSound_closure(index, audioContext, xhr));
    xhr.send();
  },
  keyboard: {
    "^": "Object;_testsound$_key",
    keyboard$0: function() {
      var t1 = H.setRuntimeTypeInfo(new W._EventStream(window, C.EventStreamProvider_keydown._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new S.keyboard_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = H.setRuntimeTypeInfo(new W._EventStream(window, C.EventStreamProvider_keyup._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new S.keyboard_closure0(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    static: {keyboard$: function() {
        var t1 = new S.keyboard(P.HashMap_HashMap(null, null, null, P.$int, P.$int));
        t1.keyboard$0();
        return t1;
      }}
  },
  keyboard_closure: {
    "^": "Closure:10;this_0",
    call$1: function(e) {
      var t1 = this.this_0._testsound$_key;
  ...
  keyboard_closure0: {
    "^": "Closure:10;this_1",
    call$1: function(e) {
      this.this_1._testsound$_key.remove$1(0, J.get$keyCode$x(e));
    }
  },
  SolarSystem: {
    "^": "Object;canvas,width,height,sun,renderTime",
    start$0: [function(_) {
      var t1, t2, t3, t4, t5, rect, Platform;
      t1 = this.canvas;
      t2 = t1.parentElement;
      t2.toString;
      t3 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2.clientLeft));
      t4 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2.clientTop));
      t5 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2.clientWidth));
      t2 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2.clientHeight));
      if (t5 < 0)
        t5 = -t5 * 0;
      if (t2 < 0)
        t2 = -t2 * 0;
      ...
      J.set$width$x(t1, t2);
      this.sun = S.PlanetaryBody$(this, "green", 0, 200, true, 0, 0);
      $.enemy = S.PlanetaryBody$(this, "red 1", 500, 200, true, 0, 0);
      P.Future_Future$delayed(C.Duration_1000000, new S.SolarSystem_start_closure(this), null);
      Platform = S.PlanetaryBody$(this, "block 1", 0, 250, false, 0, 0);
      $.get$platforms().push(Platform);
      $.sun2 = this.sun;
      t2 = window;
      t1 = this.get$draw();
    ...
    AI$0: function() {
      $.enemy.fire$1("blob");
      P.Future_Future$delayed(C.Duration_1000000, new S.SolarSystem_AI_closure(this), null);
      var t1 = $.get$globalfunction()[66];
      if (t1 != null)
        t1.call$0();
    },
    draw$1: [function(_) {
      ...
      this.renderTime = t1;
      if ($.get$k()._testsound$_key.containsKey$1(87))
        $.sun2.jump$0();
      $.sun2.moveleftright$1(0);
      if ($.get$k()._testsound$_key.containsKey$1(68))
        $.sun2.moveleftright$1(1);
      if ($.get$k()._testsound$_key.containsKey$1(65))
        $.sun2.moveleftright$1(-1);
      if ($.get$k()._testsound$_key.containsKey$1(190)) {
        if (!$.FIP) {
          $.sun2.fire$1("Arrow");
          $.FIP = true;
    ...
    drawPlanets$1: function(context) {
      ...
      if (typeof t3 !== "number")
        return t3.$div();
      t1.drawSelf$2(context, t1.calculatePos$1(H.setRuntimeTypeInfo(new P.Point(t2 / 2, t3 / 2), [null])));
      t3 = $.enemy;
      t3.drawSelf$2(context, t3.calculatePos$1(H.setRuntimeTypeInfo(new P.Point(0, 0), [null])));
      for (i = 0; t1 = $.get$arrowlist(), i < t1.length; ++i) {
        t1 = t1[i];
        t2 = new P.Point(0, 0);
        t2.$builtinTypeInfo = [null];
        t1.drawSelf$2(context, t1.calculatePos$1(t2));
      }
      for (i = 0; t1 = $.get$platforms(), i < t1.length; ++i) {
        t1 = t1[i];
        t2 = new P.Point(0, 0);
  ...
  PlanetaryBody: {
    "^": "Object;color,orbitPeriod,solarSystem,bodySize,orbitRadius,orbitSpeed,x,y,speedx,speedy,image,imageleft,imageright,imgheight,imgwidth,gravity,planets",
    ...
    calculatePos$1: function(p) {
      ...
      return H.setRuntimeTypeInfo(new P.Point(this.x, this.y), [null]);
    },
    jump$0: function() {
      var t1, t2, t3;
      t1 = this.x;
    ...
    fire$1: function(imgname) {
      var arrow, t1, t2;
      arrow = S.PlanetaryBody$(this.solarSystem, imgname, this.x, this.y, false, 0, 0);
      t1 = this.image;
      t2 = this.imageright;
    ...
    PlanetaryBody$7: function(solarSystem, color, x, y, gravity, orbitRadius, orbitPeriod) {
      var t1;
      this.speedx = 0;
      this.speedy = 0;
      t1 = this.color;
      this.imageleft = W.ImageElement_ImageElement(null, t1 + "-left.png", null);
      t1 = W.ImageElement_ImageElement(null, t1 + "-right.png", null);
      this.imageright = t1;
      this.image = t1;
    ...
    static: {PlanetaryBody$: function(solarSystem, color, x, y, gravity, orbitRadius, orbitPeriod) {
        var t1 = new S.PlanetaryBody(color, orbitPeriod, solarSystem, null, orbitRadius, null, x, y, null, null, null, null, null, null, null, gravity, H.setRuntimeTypeInfo([], [S.PlanetaryBody]));
        t1.PlanetaryBody$7(solarSystem, color, x, y, gravity, orbitRadius, orbitPeriod);
        return t1;
      }}
  },
  addSound_closure: {
    "^": "Closure:10;index_0,audioContext_1,xhr_2",
    call$1: function(e) {
      var t1 = this.audioContext_1;
      J.decodeAudioData$1$x(t1, W._convertNativeToDart_XHR_Response(this.xhr_2.response)).then$1(new S.addSound__closure(this.index_0, t1));
    }
  },
  addSound__closure: {
    "^": "Closure:10;index_3,audioContext_4",
    call$1: function(buffer) {
      ...
      if (t2 >= 100)
        return H.ioore(t1, t2);
      t1[t2] = new S.addSound___doPlaySound(this.audioContext_4, buffer);
    }
  },
  addSound___doPlaySound: {
    "^": "Closure:1;audioContext_5,buffer_6",
    call$0: function() {
      var t1, source;
...
function dart_precompiled($collectedClasses) {
  ...
  function keyboard(_testsound$_key) {
    this._testsound$_key = _testsound$_key;
  }
  ...
  function PlanetaryBody(color, orbitPeriod, solarSystem, bodySize, orbitRadius, orbitSpeed, x, y, speedx, speedy, image, imageleft, imageright, imgheight, imgwidth, gravity, planets) {
    this.color = color;
